                ...
                for employee in employees:
                    if(location != ""):
                        if employee["location"].lower() == location.lower():
                            if employee["firstName"].lower() == "charles":
                                print(employee)
                                print(bamboo.get_tabular_data(
...
for employee in employees:
    ...
    print(employee)
    # print('{} {}|{}|{}'.format(
    #    employee["firstName"], employee["lastName"], employee["workEmail"], employee["jobTitle"]))
